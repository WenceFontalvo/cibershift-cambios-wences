		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			<div class="container">
				...
				<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item active"><a class="nav-link" href="<?php echo base_url();?>appointment">Cita</a></li>
						<li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>contact">Contacto</a></li>
					</ul>
				</div>
			</div>
		</nav>
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12">
						<div class="title title-1 text-center">
							...
							<ol class="breadcrumb">
								<li><a href="http://localhost/CIBERSHIFT/public/index">Inicio</a></li>
								<li class="active"></li>
							</ol>
						</div>
						<!-- .title end -->
